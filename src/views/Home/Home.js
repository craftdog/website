...
import SirajJPG from "../../assets/siraj.jpg";
      ...
      <>
          ...
          <Container>
            <Row>
              <Col lg={6} md={7}>
                ...
                <p>
                  We make cool and usable software. Check out our work and feel
                  free to contact us below.
                </p>
                <a href="#contact" className="btn">
                  Contact Us
                </a>
                <a href="#our-work" className="btn secondary">
                  Check Out Our Work
                </a>
              </Col>
              <Col lg={6} md={5}>
        ...
        <section id="work">
          <Container style={{ position: "relative" }}>
            <Visible lg xl>
              <a href="#our-work" id="scroll-button">
                &larr; SCROLL
              </a>
            </Visible>
            ...
            <Row justify="between">
              <WorkCard
                ...
                color="var(--blue)"
                link="https://github.com/craftdog/train-tracker"
              />
              <WorkCard
                icon={faMapMarkedAlt}
                name="Illini Tours"
        ...
        <section id="about">
          <Container>
            ...
            <p>
              We are two University of Illinois students applying our studies in
              the areas of
        ...
        <section id="contact">
          <Container>
            ...
            <ul>
              <li>
                <a
                  href="mailto:mail@craftdog.dev"
                  style={{ color: "var(--blue)" }}
                >
                  <FontAwesomeIcon icon={faPaperPlane} /> mail@craftdog.dev
                </a>
              </li>
              <li>
                <a
                  href="https://github.com/craftdog"
                  target="_blank"
              ...
              <li>
                ...
                >
                  <FontAwesomeIcon icon={faDribbble} /> Dribbble
                </a>
              </li>
              <li>
